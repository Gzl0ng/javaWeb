...
5.QQZone登录功能实现出现的四个错误：
 ...
 4）Can not set com.gzl0ng.qqzone.pojo.UserBasic field com.gzl0ng.qqzone.pojo.Topic.author to java.lang.Integer
...
6. 删除日志
   ...
   修改BaseDAO，让其支持properties文件以及druid数据源连接池
   讲解了二种方式：
   1）直接自己配置properties，然后读取，然后加载驱动
   2）所有druid连接池技术，那么properties中的key是有要求的